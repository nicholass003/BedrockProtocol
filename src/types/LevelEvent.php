...
final class LevelEvent{
	...
	public const PARTICLE_TRIAL_SPAWNER_DETECTION_CHARGED = 3615;
	public const PARTICLE_TRIAL_SPAWNER_BECOME_CHARGED = 3616;
	...
	public const ANIMATION_SPAWN_COBWEB = 9814;
	public const PARTICLE_SMASH_ATTACK_GROUND_DUST = 9815;
	public const PARTICLE_CREAKING_HEART_TRAIL = 9816;
